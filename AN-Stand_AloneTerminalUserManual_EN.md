...
<table>
	...
	<tr>
		...
		<td> 
			Complete the unit price for the product. Normally the terminal will show the value that the station usually operates with that product. You can edit it if necessary.<br>
			<br>NOTE: the terminal, depending on the configuration of the card, can repeat this step asking other data. Repeat until all data has been responded.
		</td>
	</tr>
	<tr>
